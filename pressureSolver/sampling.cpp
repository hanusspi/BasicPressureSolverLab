...
void pressureSolver::sampling::fluid_box(std::vector<Eigen::Vector3d>& particles, const Eigen::Vector3d& bottom, const Eigen::Vector3d& top, const double sampling_distance)
{
	// Center the sampling
...
void pressureSolver::sampling::triangle_mesh(std::vector<Eigen::Vector3d>& particles, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles, const double sampling_distance)
{
...
std::vector<std::array<int, 2>> pressureSolver::sampling::_find_edges(const std::vector<std::array<int, 3>>& triangles)
{
...
void pressureSolver::sampling::_sample_triangle(std::vector<Eigen::Vector3d>& particles, const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& c, const double sampling_distance)
{
...
bool pressureSolver::sampling::_point_on_triangle(const Eigen::Vector3d& a, const Eigen::Vector3d& b, const Eigen::Vector3d& c, const Eigen::Vector3d& n, const Eigen::Vector3d& p)
{
